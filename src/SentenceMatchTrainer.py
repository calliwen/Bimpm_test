...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default=str("../data/train.tsv"), help='Path to the train set.')
    parser.add_argument('--dev_path', type=str, default=str("../data/dev.tsv"), help='Path to the dev set.')
    parser.add_argument('--test_path', type=str, default=str("../data/test.tsv"), help='Path to the test set.')
    parser.add_argument('--word_vec_path', type=str, help='Path the to pre-trained word vector model.')
    parser.add_argument('--model_dir', type=str, default=str("../data/model/"), help='Directory to save model files.')
    ...
    parser.add_argument('--config_path', default=str("../configs/snli.sample.config"), type=str, help='Configuration file.')
